...
const ExperienceSection: React.FC = () => {
  ...
  const experiences = [
    {
      title: "Jr. Computer vision Engineer",
      company: "Xis.ai",
      location: "Sternenfels, Germnany",
      period: "January 2026 - Present",
      type: "Full-time",
      description: "Contributing to the development of AI-driven solutions and applications that support industrial inspection and quality assurance.",
      achievements: [
        "Developed and deployed computer vision models for quality assurance",
        "Implemented OCR and vision-based pipelines improving model processing speed by 90%",
        "Collaborated with cross-functional teams to enhance product features"
      ],
      technologies: ["Python", "PyTorch", "TensorRT", "Docker", "Git", "Vision Models", "Roboflow"],
